    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
            <div class="grid sm:grid-cols-2 gap-8">
                <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">{{ __('Email') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">contact@bucharestpride.ro</p>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">{{ __('Location') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('Bucharest, Romania') }}</p>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">{{ __('Social Media') }}</h3>
                    <div class="flex gap-3 mt-1">
                        <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-pink-600 dark:hover:text-pink-400 transition">
                        ...
                        <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition">
