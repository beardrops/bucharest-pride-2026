...
<section id="volunteer" class="py-20">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white ml-2">{{ __('Volunteer') }}</h2>
        </div>
...
<section id="sponsors" class="py-20 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="w-3 h-3 rounded-full bg-blue-500"></span>
            <span class="w-3 h-3 rounded-full bg-purple-600"></span>
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white ml-2">{{ __('Sponsors') }}</h2>
        </div>
        <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            {{ __('Sponsor desc') }}
        </p>
...
<section id="donations" class="py-20">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="w-3 h-3 rounded-full bg-blue-500"></span>
            <span class="w-3 h-3 rounded-full bg-purple-600"></span>
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white ml-2">{{ __('Donations') }}</h2>
        </div>
        <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            {{ __('Donate desc') }}
        </p>
...
<section id="community" class="py-20 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3 mb-6">
            <span class="w-3 h-3 rounded-full bg-red-500"></span>
            <span class="w-3 h-3 rounded-full bg-yellow-400"></span>
            ...
            <span class="w-3 h-3 rounded-full bg-blue-500"></span>
            <span class="w-3 h-3 rounded-full bg-purple-600"></span>
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white ml-2">{{ __('Community') }}</h2>
        </div>
        <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
