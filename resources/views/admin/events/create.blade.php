                ...
                <div class="p-6 text-pride-black dark:text-white">
                    <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="ticket_url" class="mt-1 block w-full" type="url" name="ticket_url" :value="old('ticket_url')" placeholder="https://www.eventbrite.com/e/..." />
                        ...
                        <div>
                            ...
                            <x-text-input id="ticket_label" class="mt-1 block w-full" type="text" name="ticket_label" :value="old('ticket_label')" placeholder="e.g. Buy Now, Get Tickets, Cumpără Bilete" />
