        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-pride-beige border-2 border-pride-black p-8 text-center group">
                <div class="w-16 h-16 mx-auto mb-5 flex items-center justify-center">
                    <svg class="w-10 h-10 text-pride-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/>
                    </svg>
                </div>
                <h3 class="font-head font-semibold text-xl text-pride-black mb-3 uppercase">{{ __('Volunteer') }}</h3>
                <p class="text-sm text-gray-600 leading-relaxed mb-6">{{ __('Volunteer desc') }}</p>
                <a href="#" class="font-head font-semibold text-sm text-pride-pink inline-flex items-center gap-2 uppercase tracking-wider">{{ __('Volunteer') }} &rarr;</a>
            </div>
            <div class="bg-pride-beige border-2 border-pride-black p-8 text-center group">
                <div class="w-16 h-16 mx-auto mb-5 flex items-center justify-center">
                    <svg class="w-10 h-10 text-pride-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="font-head font-semibold text-xl text-pride-black mb-3 uppercase">{{ __('Donate') }}</h3>
                <p class="text-sm text-gray-600 leading-relaxed mb-6">{{ __('Donate desc') }}</p>
                <a href="#" class="font-head font-semibold text-sm text-pride-pink inline-flex items-center gap-2 uppercase tracking-wider">{{ __('Donate') }} &rarr;</a>
            </div>
            <div class="bg-pride-beige border-2 border-pride-black p-8 text-center group">
                <div class="w-16 h-16 mx-auto mb-5 flex items-center justify-center">
                    <svg class="w-10 h-10 text-pride-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="font-head font-semibold text-xl text-pride-black mb-3 uppercase">{{ __('Sponsor') }}</h3>
                <p class="text-sm text-gray-600 leading-relaxed mb-6">{{ __('Sponsor desc') }}</p>
                <a href="#" class="font-head font-semibold text-sm text-pride-pink inline-flex items-center gap-2 uppercase tracking-wider">{{ __('Become a Sponsor') }} &rarr;</a>
            </div>
        </div>
    </div>
</section>
